...
let resultadoTela = document.getElementById("resultado");
    ...
    resultadoTela.innerText = `Bem vindo a calculadora Online!`;
        ...
        if(isNaN(n1) || isNaN(n2)){
            ...
            let result = n1 + n2 ;
            resultadoTela.innerText = `${n1} + ${n2} = ${result.toFixed(0)}`;
        } else if (operacao == "-"){
            let result = n1 - n2 ;
            resultadoTela.innerText = `${n1} - ${n2} = ${result.toFixed(0)}`;
        // || --> significa or (ou)/ se operacao for igual a X ou x 
            ...
            let result = n1 * n2 ;
            resultadoTela.innerText = `${n1} X ${n2} = ${result.toFixed(0)}`;
        } else if (operacao == "/") {
            let result = n1 / n2;
            resultadoTela.innerText =  `${n1}/${n2} = ${result.toFixed(0)}` ;
        } else if (operacao == "^" || operacao == "**"){
            let result = n1 ** n2 ;
            resultadoTela.innerText = `${n1} elevado a ${n2} = ${result.toFixed(0)}`;  
